...
import { get_instruction, create_step } from '../api'

class ShowInstruction extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      instruction: null, //{},
    ...
    return (
      <div className="container-fluid">
        <div className="row align-items-center">
          {instruction && <Instruction instruction={instruction} saveCallback={this.instructionCallback} />}
          {this.renderSteps()}
        </div>
      </div>
    )
